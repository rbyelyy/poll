...
class FreezeCommand(Command):
    ...
    def __init__(self, *args, **kw):
        ...
        self.cmd_opts.add_option(
            ...
            default=None,
            metavar='file',
            help="Use the order in the given requirements.txt file and it's comments when generating output.")
        self.cmd_opts.add_option(
            '-f', '--find-links',
            dest='find_links',
            action='append',
    ...
    def run(self, options, args):
        ...
        if requirement:
            ...
            f.write('## The following requirements.txt were added by pip --freeze:\n')
