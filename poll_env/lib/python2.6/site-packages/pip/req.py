            ...
            try:
                ...
                # sdists
                    ...
                    if (req_to_install.extras):
                        logger.notify("Installing extra requirements.txt: %r" % ','.join(req_to_install.extras))
                    if not self.ignore_dependencies:
...
'''
    ...
    def bundle_requirements(self):
        ...
        parts.append('# These packages were installed to satisfy the above requirements.txt:\n')
        for req in [req for req in self.requirements.values()
                    if req.comes_from]:
            parts.append('%s==%s\n' % (req.name, req.installed_version))
...
def parse_requirements(filename, finder=None, comes_from=None, options=None,
    ...
    for line_number, line in enumerate(content.splitlines()):
        ...
        if line.startswith('-r') or line.startswith('--requirement'):
            ...
            ## the find_links:
            # support a find-links local path relative to a requirements.txt file
